...
Contains `exp1_cause_children.csv` which includes trial adn demographic data. Also includes `chain_cause_different_responses.csv` which was used in the RSA model.
...
Contains `exp1_made_children.csv` which includes trial adn demographic data. Also includes `chain_made_different_responses.csv` which was used in the RSA model.
...
Contains `exp2_cause_children.csv` which includes trial adn demographic data. Also includes `absence_cause_different_responses.csv` which was used in the RSA model.
...
Contains `exp2_made_children.csv` which includes trial adn demographic data. Also includes `absence_made_different_responses.csv` which was used in the RSA model.
