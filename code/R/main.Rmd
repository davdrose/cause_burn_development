...
df.chain_cause_adults = df.cause_adults_differnet %>% 
  bind_rows(df.cause_adults_both)
...
df.chain_cause_children = df.cause_children_differnet %>% 
  bind_rows(df.cause_children_both) 
...
pairs(emmeans(fit.brm.chain.cause.children,
              ~question))
...
df.chain_made_adults = df.made_adults_differnet %>% 
  bind_rows(df.made_adults_both) 
...
df.chain_made_children = df.made_children_differnet %>% 
  bind_rows(df.made_children_both) 
...
gradient_segments = data.frame(
  ...
  y = seq(0, 1, length.out = 100),
  yend = seq(0, 1, length.out = 100),
  color = scales::gradient_n_pal(c("#377EB8", "#377EB8","#377EB8", "#377EB8", "#E41A1C", "#E41A1C", "#E41A1C"))(seq(0, 1, length.out = 100))
)
...
ggsave("../../figures/experiment1/chain_cause_response_gradient.pdf", height = 4, width = 8)
