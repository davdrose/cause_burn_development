  ...
  if(nprior == 2){
    p.prior = ggplot() + 
      geom_col(mapping = aes(x = 1:2,
                             ...
                             fill = c("chain", "absence")),
               color = "black", 
               show.legend = F) + 
      scale_x_continuous(breaks = c(1, 2),
                         labels = c("chain", "absence")) +
      scale_fill_manual(values = c("chain" = "#377EB8",
                                   "absence" = "#E41A1C")) + 
      scale_y_continuous(breaks = seq(0, 0.5, 0.1),
                         limits = c(0, 0.5)) + 
      labs(x = "scenario",
...
ggsave("../../figures/rsa/model_fits.pdf",
       width = 10,
       height = 7)
