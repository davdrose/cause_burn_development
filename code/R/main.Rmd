...
p4 = ggplot(mapping = aes(x = age, 
  ...
  facet_wrap(~type,
             labeller = custom_labels) + 
  scale_fill_manual(values = c("made" = "#FFFF33", "lexical" = "#4DAF4A"), breaks=c("made", "lexical")) +
  scale_color_manual(values = c("made" = "#FFFF33", "lexical" = "#4DAF4A"), breaks=c("made", "lexical")) +
